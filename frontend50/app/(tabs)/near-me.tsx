      ...
      <View style={{ flex: 1 }}>
        ...
        >
          {mechanics.map((mechanic) => (
            ...
            >
              <View style={{ backgroundColor: mechanic.isVerified ? "#f59e0b" : colors.blue, borderRadius: 20, padding: 8, borderWidth: 2, borderColor: "white", alignItems: "center", justifyContent: "center" }}>
                <Text style={{ fontSize: 14 }}>{mechanic.isVerified ? "🏁" : "🔧"}</Text>
              </View>
              <Callout tooltip>
                <View style={{ backgroundColor: colors.card, borderRadius: 10, padding: 10, borderWidth: 1, borderColor: mechanic.isVerified ? "#f59e0b" : colors.border, minWidth: 140 }}>
        ...
        {selectedPin && (
          <View style={{ position: "absolute", bottom: 0, left: 0, right: 0, backgroundColor: colors.card, borderTopLeftRadius: 20, borderTopRightRadius: 20, borderTopWidth: 1, borderColor: colors.border, padding: 20 }}>
            <View style={{ flexDirection: "row", alignItems: "center", gap: 12, marginBottom: 12 }}>
              <View style={{ width: 48, height: 48, borderRadius: 24, backgroundColor: colors.border, borderWidth: 2, borderColor: selectedPin.isVerified ? "#f59e0b" : colors.blue, justifyContent: "center", alignItems: "center" }}>
